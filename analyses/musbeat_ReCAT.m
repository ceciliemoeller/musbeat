...
addpath 'C:\Users\au213911\Documents\musbeat\analyses'
cd 'C:\Users\au213911\Documents\musbeat\analyses'

%% NEW re-CATEGORIZATION for all sub and rhythms

% %reading myTEMPO table TEMPO
% TChosenMeter=table2array(readtable('myData_PITCH.xlsx','Range','PE2:PW81', 'ReadVariableNames',false));
% Ttapping_dataITI_mean=table2array(readtable('myData_PITCH.xlsx','Range','C2:U81', 'ReadVariableNames',false));
% Ttapping_dataITI_SD=table2array(readtable('myData_PITCH.xlsx','Range','V2:AN81', 'ReadVariableNames',false));
% 
...
T_PITCH_reCAT = array2table(newChosenMeter,'VariableNames',ColumnNames);
writetable(T_PITCH_reCAT,'myData_PITCH_reCAT.csv','Delimiter',',','QuoteStrings',true) %type 'myData.csv'
writetable(T_PITCH_reCAT,'myData_PITCH_reCAT.xlsx') %type 'myData.csv'


%% load('T_PITCH.mat')
T_PITCH_final=[T_PITCH T_PITCH_reCAT];
writetable(T_PITCH_final,'myData_musbeat_final.csv','Delimiter',',','QuoteStrings',true) %type 'myData.csv'
writetable(T_PITCH_final,'myData_musbeat_final.xlsx') %type 'myData.csv'